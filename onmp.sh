...
url_phpMyAdmin="https://files.phpmyadmin.net/phpMyAdmin/4.8.4/phpMyAdmin-4.8.4-all-languages.zip"

# (2) WordPress（使用最广泛的CMS）
url_WordPress="https://cn.wordpress.org/wordpress-5.0.3-zh_CN.zip"

# (3) Owncloud（经典的私有云）
url_Owncloud="https://download.owncloud.org/community/owncloud-10.0.10.zip"

# (4) Nextcloud（Owncloud团队的新作，美观强大的个人云盘）
url_Nextcloud="https://download.nextcloud.com/server/releases/nextcloud-15.0.2.zip"
...
url_Kodexplorer="http://static.kodcloud.com/update/download/kodexplorer4.37.zip"
...
vhost_list()
{
    ...
    echo "浏览器地址栏输入：$localhost:9000 查看php探针"
}
...
install_nextcloud()
{
    ...
    # 添加少的文件夹
	[ ! -d "/opt/wwwroot/Nextcloud/data" ] && mkdir -p -m 777 "/opt/wwwroot/Nextcloud/data"
